/* Generated By:JavaCC: Do not edit this line. SpecialTokenTokenManager.java Version 8.0.0 */
package special.special8;


public class SpecialTokenTokenManager  implements SpecialTokenConstants {
...
protected static boolean moveToNextChar() {
  ...
  int linesCommentCount = 0;
    ...
    /** Constructor. */
    public SpecialTokenTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public SpecialTokenTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
...
private static   int[] stateSet = new int[10];
private static   int[] newStateSet = new int[10];
private static   long[] moved = new long[10];
...
private static final long[][] jjChars = new long[10][];
...
startAndSize.put(65578, new int[]{15, 1});
startAndSize.put(13, new int[]{21, 1});
startAndSize.put(45, new int[]{26, 1});
startAndSize.put(65583, new int[]{32, 1});
startAndSize.put(47, new int[]{38, 1});
}
...
new long[] {1, -35184372098049L, 3, -1L},
new long[] {1, 1024L},
new long[] {1, 8192L},
new long[] {1, 9216L},
...
/* JavaCC - OriginalChecksum=67099898b73b565eb6dea167bd706ec0 (do not edit this line) */
