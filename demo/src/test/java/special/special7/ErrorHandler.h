...
JJSimpleString addUnicodeEscapes(const JJString& str);
  ...
  class ErrorHandler {
    ...
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, const JJString& expectedToken, Token *actual, SpecialToken *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, const JJSimpleString& production, SpecialToken *parser) {
        error_count++;
  ...
  class TokenManagerErrorHandler {
    ...
    public:
       ...
       //
       virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, const JJString& errorAfter, JJChar curChar, SpecialTokenTokenManager* token_manager) {
       ...
       virtual void lexicalError(const JJString& errorMessage, SpecialTokenTokenManager* token_manager) {
...
/* JavaCC - OriginalChecksum=a938fe4abbfd55b1e1a29cb54233d765 (do not edit this line) */
