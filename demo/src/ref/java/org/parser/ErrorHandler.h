...
#ifndef JAVACC__Expression_ERRORHANDLER_H_
#define JAVACC__Expression_ERRORHANDLER_H_
#include <string>
#include "JavaCC.h"
#include "Token.h"
...
JAVACC_SIMPLE_STRING addUnicodeEscapes(const JAVACC_STRING_TYPE& str);
  ...
  class ErrorHandler {
    ...
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, JAVACC_STRING_TYPE expectedToken, Token *actual, Expression *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, JAVACC_SIMPLE_STRING production, Expression *parser) {
        error_count++;
      ...
      virtual void handleOtherError(JAVACC_STRING_TYPE message, Expression *parser) {
  ...
  class TokenManagerErrorHandler {
    ...
    public:
      ...
      //
      virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, JAVACC_STRING_TYPE errorAfter, JAVACC_CHAR_TYPE curChar, ExpressionTokenManager* token_manager) {
      ...
      virtual void lexicalError(JAVACC_STRING_TYPE errorMessage, ExpressionTokenManager* token_manager) {
