...
private:
  ...
  Token * jjFillToken();
  void reportError(int lastReadPosition);
...
/* JavaCC - OriginalChecksum=a06f312389e37328ad4b18ac46ea64ce (do not edit this line) */
